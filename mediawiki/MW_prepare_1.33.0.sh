...
# better.
#
# Effect (MW + bundled extensions + CodeMirror + intersection + Maintenance)
# 16,386 items (151.0 MB) -> 6,089 items (35.9 MB)
#
...
# Remove all the crap
xargs --interactive --arg-file=MW_prepare_phan_deletion.lst /bin/rm -f --recursive
