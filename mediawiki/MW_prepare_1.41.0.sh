...
rm --force --recursive \
	...
	./"$1"/vendor/wikimedia/parsoid/config.example.yaml \
	./"$1"/vendor/wikimedia/parsoid/htmldiffs.config.example.yaml \
	./"$1"/vendor/wikimedia/parsoid/localsettings.example.js \
	./"$1"/vendor/wikimedia/parsoid/readviewstrip.config.example.yaml \
